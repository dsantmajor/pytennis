    ...
    def points_won_by(self, player_name):
        ...
        if player_name == self._p1_name:
            ...
            if self._p1_games_won == 6 and self._p2_games_won == 5:
                ...
                print(f"Player1 won Set {self._p1_games_won} - {self._p2_games_won} ")
                match.p1_reset_points_games()
                # Solve for Tie-Breaker
            elif self._p1_games_won == 6 and self._p2_games_won == 6:
                print(f"Tie Break: {self._p1_games_won} - {self._p1_games_won} ")
                ...
                if self._p1_tiebrk_points_won >= 7 and self._p1_tiebrk_points_won - self._p2_tiebrk_points_won >= 2:
                    ...
                    print(f"Player 1 tie break points reset : {self._p1_tiebrk_points_won }")
                    self._p2_tiebrk_points_won = 0
                    print(f"Player 2 tie break points reset : {self._p2_tiebrk_points_won}")
                ...
                Match.counter += 1
                print(f"Count {Match.counter}: P1 Points Won: {self._p1_points_won}")
            ...
            print(f"Count {Match.counter}: Outer: Name: {self._p1_name} Points Won: {self._p1_points_won} Games Won: {self._p1_games_won}")
        
        elif player_name == self._p2_name:

            if self._p2_games_won == 6 and self._p1_games_won == 5:
                self._p2_games_won += 1
                print(f"Player2 won Set {self._p2_games_won} - {self._p1_games_won}")
                match.p2_reset_points_games()
                # Solve for Tie-Breaker
            elif self._p2_games_won == 6 and self._p1_games_won == 6:
                print(f"Tie Break: {self._p2_games_won} - {self._p1_games_won} ")
                ...
                if self._p2_points_won == 3 and self._p1_points_won == 3:
                    print(f"Its a Deuce: P1{self._p1_points_won} - P2{self._p2_points_won}")
            ...
            print(f"Count {Match.counter}: Outer: Name: {self._p2_name} Points Won: {self._p2_points_won} Games Won: {self._p2_games_won}")
